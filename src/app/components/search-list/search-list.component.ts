...
import { ICategory } from './../../models/interfaces/interfaces';
...
export class SearchListComponent implements OnInit {
  ...
  /**
   * view searchQueryInput.
   */
  @ViewChild('searchQueryInput') searchQueryInput: any;
  ...
  onCategorySelect(category: ICategory): void {
    ...
    /**update the state ---> [categorySelected]*/
    this.commonStateService.updateCategorySelected(category);
  ...
  onSearch(event: any, preventDefault?: boolean) {
    if (preventDefault) {
  ...
  /**
   * keyup search Field
   * @param searchQuery Consulta.
   */
  onKeyUp(searchQuery: string) {
    this.searchQuery = searchQuery;

    this.categories=this.searchResult.filter(cat=>
{
  cat.description==searchQuery}
  ...
  onChange() {
    this.searchQuery = this.searchQueryInput.nativeElement.value;
  }
}
